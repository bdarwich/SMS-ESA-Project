...
document.querySelector('#searchStd').addEventListener('keyup', (e)=>{
var input, filter, table, tr, td, i, txtValue;
input = e.target;
filter = input.value.toUpperCase();
table = document.getElementById("studentsDataTable");
...
/**************Function to search headmasters by name**************/
document.querySelector('#searchHeadmaster').addEventListener('keyup', (e)=>{
var input, filter, table, tr, td, i, txtValue;
input = e.target;
filter = input.value.toUpperCase();
table = document.getElementById("headmastersDataTable");
tr = table.getElementsByTagName("tr");
for (i = 0; i < tr.length; i++) {
  td = tr[i].getElementsByTagName("td")[2];
  if (td) {
...
document.querySelector('#searchTeacher').addEventListener('keyup', (e)=>{
var input, filter, table, tr, td, i, txtValue;
input = e.target;
filter = input.value.toUpperCase();
table = document.getElementById("teachersDataTable");
tr = table.getElementsByTagName("tr");
for (i = 0; i < tr.length; i++) {
  td = tr[i].getElementsByTagName("td")[2];
  if (td) {
